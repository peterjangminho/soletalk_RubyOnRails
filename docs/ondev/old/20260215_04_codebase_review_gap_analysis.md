...
| ops | 로그인 사용자 기준 운영 validate/restore E2E 증적 미확보 | Closed | High | `P76-T3b` 완료: request_id `80aca412-77e5-4e1f-bba6-440e3023c2cb`, `Completed 302 Found` 증적 확보 |
...
- Verify:
  ...
  - `P76-T3b` 완료: 로그인 사용자 기준 `/subscription/validate` restore flow `302` 로그 증적 확보
